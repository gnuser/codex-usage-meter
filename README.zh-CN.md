...
- **第一次安装**：[分平台安装指南](docs/INSTALL.zh-CN.md)
- **已经装好**：[使用指南与快速排障](docs/USAGE.zh-CN.md)
...
更多说明见 [能力与边界](docs/CAPABILITIES.zh-CN.md)。
...
HTTP 测试需要监听本机临时端口。历史版本验证见 [测试记录](docs/VALIDATION.zh-CN.md)，辅助工具来源见 [工具来源](tools/PROVENANCE.zh-CN.md)。
