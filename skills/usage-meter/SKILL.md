...
3. Call `usage_dashboard` to show the interactive UI. Open the returned loopback URL using the host browser/panel capability when available, otherwise give a clickable URL. The MCP process must remain alive.
