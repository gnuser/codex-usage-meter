...
[安装指南](INSTALL.zh-CN.md) · [返回首页](../README.zh-CN.md) · [30 秒重点演示](media/getting-started.mp4)
...
- **暂停**：菜单栏／托盘右键选择“Quit and pause auto-open”。恢复方法见 [手动打开](INSTALL.zh-CN.md#不想配置自动启动手动打开)。
...
先完成 [Chrome 连接](INSTALL.zh-CN.md#可选连接-tibo-主题帖监控)。点击 Tibo 行可以查看：
...
更完整的配置、更新和卸载方法见 [README](../README.zh-CN.md)。
